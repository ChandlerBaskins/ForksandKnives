...
const Card = props => (
    <div className=" dib ma3 br2 ba dark-gray b--washed-green mv4 w-100 w-50-m w-25-l mw5 tc shadow-3">
        ...
        <button className="f6 grow  br-pill pa2 pv2 white bg-dark-green">Favorite</button>
        <button className="f6 grow  br-pill pv2 white bg-dark-green ">Ingredients</button>
        </div>
    </div>
);
